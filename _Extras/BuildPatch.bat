...
if exist "%cd%\Compilation\Mods\%modname%\Data\Global%streamversion%.manifest" if exist "%cd%\Mods\%modname%\Assets\Global" (
	"%cd%\Tools\AssetMerger.exe" "%cd%\Compilation\Mods\%modname%\Data\Global%streamversion%.manifest" "%cd%\Mods\%modname%\Assets\Global"
	"%cd%\Tools\StreamSorter.exe" "%cd%\Compilation\Mods\%modname%\Data\Global%streamversion%.manifest"
)
...
if exist "%cd%\Mods\%modname%\Data\Static.xml" (
	...
	if exist "%cd%\Compilation\Mods\%modname%\Data\Static_l%streamversion%.manifest" if exist "%cd%\Mods\%modname%\Assets\Static" (
		"%cd%\Tools\AssetMerger.exe" "%cd%\Compilation\Mods\%modname%\Data\Static_l%streamversion%.manifest" "%cd%\Mods\%modname%\Assets\Static"
		"%cd%\Tools\StreamSorter.exe" "%cd%\Compilation\Mods\%modname%\Data\Static_l%streamversion%.manifest"
	)
...
if exist "%cd%\Mods\%modname%\LanguagePacks" (
	...
	for /D %%A in ("*") do (
		...
		if exist "!sdk!\Compilation\Mods\%modname%\LanguagePacks\%%A\Data\Global_%%A%streamversion%.manifest" if exist "!cd!\%%A\Assets\Global_%%A%streamversion%" (
			"!sdk!\Tools\AssetMerger.exe" "!sdk!\Compilation\Mods\%modname%\LanguagePacks\%%A\Data\Global_%%A%streamversion%.manifest" "!cd!\%%A\Assets\Global_%%A%streamversion%"
			"!sdk!\Tools\StreamSorter.exe" "!sdk!\Compilation\Mods\%modname%\LanguagePacks\%%A\Data\Global_%%A%streamversion%.manifest"
		)
